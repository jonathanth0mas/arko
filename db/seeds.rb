...
Item.create(name: "CHICKEN LOLLIPOP", mediumT: 55, largeT: 105, dish: "Chicken", desc:"Breaded chicken in the form of a lollipop")
...
Item.create(name: "DAING NA BANGUS", each: 8, dish: "Per Piece or Pound", desc: "Marinated & fried milk fish")
