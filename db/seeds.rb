...
Item.create(name: "CALAMARI", smallT: 35, mediumT: 65, largeT: 130, smallC: 4, mediumC: 7.5, largeC: 14, dish:"Seafood(SQUID)", desc: "Batter-coated, deep fried squid")
Item.create(name: "INIHAW NA PUSIT(Jumbo)", misc: "MARKET PRICE", dish:"Seafood(SQUID)", desc: "Grilled stuffed squid")
...
# Seafood (fish)
Item.create(name: "FRIED MILKFISH(DAING)", each: 8, dish:"Seafood(FISH)", desc: "Fried marinated milk fish")
...
Item.create(name: "FRIED SMELT(REGULAR)", misc: "PER LB", smallC: 3.5, mediumC: 6, largeC: 12, dish:"Seafood(FISH)", desc: "Fried and breaded smelt")
Item.create(name: "GINATAANG ISDA", misc: "BASED ON AVAILABILITY", dish:"Seafood(FISH)", desc: "Fish in creamy coconut & spicy sauce")
...
Item.create(name: "RELLENONG BANGUS", each: 16, dish:"Seafood(FISH)", desc: "Stuffed milkfish")
...
Item.create(name: "SWEET & SOUR FISH FILLET", smallT: 32, mediumT: 60,largeT: 115, smallC: 3.5, mediumC: 7, largeC: 14, dish:"Seafood(FISH)", desc: "Fried battered fish filet in sweet & sour sauce")
...
# Kambing
Item.create(name: "KALDERETANG KAMBING", smallT: 38, mediumT: 75, largeT: 150, smallC: 4.5, mediumC: 8, largeC: 16, dish:"Kambing", desc: "Goat meat stewed in tomato sauce")
...
Item.create(name: "CHICHARON BULAKLAK", misc: "MARKETPRICE", dish: "Per Piece or Pound", desc: "Deep fried pork intestine")
...
Item.create(name: "OKOY WITH TOGE", each: 3.50, dish: "Per Piece or Pound", desc: "Mongo sprout (togue) and shrimps")
Item.create(name: "OKOY WITH DULONG", misc: "BASED ON AVAILABILITY", dish: "Per Piece or Pound", desc: "Silverfish omelette")
...
Item.create(name: "TURON (Saging)", misc: "MARKETPRICE", dish: "Desserts per Piece", desc: "Deep fried banana rolls w/ jack fruit")
...
Item.create(name: "BUKO PANDAN", smallT: 20, mediumT: 37, largeT: 70, dish: "Desserts", desc: "Young coconut & screwpine leaves locally known as Pandan")
Item.create(name: "GINATAANG NA HALO HALO", smallT: 18, mediumT: 35, largeT: 70, dish: "Desserts", desc: "Glutinous rice balls, tubers, tropical fruits, & coconut milk")
Item.create(name: "GINATAANG NA MAIS", smallT: 15, mediumT: 30, largeT: 60, dish: "Desserts", desc: "Whole kernel corn & coconut milk")
