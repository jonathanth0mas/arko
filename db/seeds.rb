...
Item.create(name: "VEGETABLE WITH PORK & TOFU", :remote_image_url => "http://i.imgur.com/Bl499aX.jpg", smallT: 27, mediumT: 50, largeT: 95, smallC: 3.5, mediumC: 6, largeC: 12, dish: "Vegetable", desc:"Sauteed vegetables w/ pork & tofu")
...
Item.create(name: "FRIED SMELT(REGULAR)", :remote_image_url => "http://i.imgur.com/mgRoyqO.jpg", misc: "PER LB", smallC: 3.5, mediumC: 6, largeC: 12, dish:"Seafood(FISH)", desc: "Fried and breaded smelt")
...
Item.create(name: "OKOY WITH DULONG", :remote_image_url => "http://i.imgur.com/IJ4Vjz2.jpg", misc: "BASED ON AVAILABILITY", dish: "Per Piece or Pound", desc: "Silverfish omelette")
